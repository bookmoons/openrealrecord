...
class ModuleRelay {
   ...
   * @param {DeliverStop} prot.stopSender - Stop message sender.
  ...
  constructor ({ stopSender }, exposer) {
    ...
    const doneSender = privm.doneSender.bind(this)
 ...
 * @param {DeliverDone} prot.doneSender - Send done message.
 */
